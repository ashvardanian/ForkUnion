...
```toml
[dependencies]
forkunion = "3.0.3"                                          # detect what the platform offers
forkunion = { version = "3.0.3", features = ["portable"] }   # STL thread pool only
forkunion = { version = "3.0.3", features = ["place-memory-on-domain"] } # require NUMA-aware allocations
```
